...
| *`allowInsideAdmissionControllerNamespace`* __boolean__ | AllowInsideAdmissionControllerNamespace controls whether the policy should also be +
...
| *`verificationConfig`* __string__ | Name of VerificationConfig configmap in the kubewarden namespace (same +
...
| *`sigstoreTrustConfig`* __string__ | Name of SigstoreTrustConfig configmap in the kubewarden namespace (same +
