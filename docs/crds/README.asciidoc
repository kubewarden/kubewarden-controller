...
.Resource Types
- xref:{anchor_prefix}-github-com-kubewarden-kubewarden-controller-apis-v1alpha2-admissionpolicy[$$AdmissionPolicy$$]
- xref:{anchor_prefix}-github-com-kubewarden-kubewarden-controller-apis-v1alpha2-admissionpolicylist[$$AdmissionPolicyList$$]
- xref:{anchor_prefix}-github-com-kubewarden-kubewarden-controller-apis-v1alpha2-clusteradmissionpolicy[$$ClusterAdmissionPolicy$$]
- xref:{anchor_prefix}-github-com-kubewarden-kubewarden-controller-apis-v1alpha2-clusteradmissionpolicylist[$$ClusterAdmissionPolicyList$$]
- xref:{anchor_prefix}-github-com-kubewarden-kubewarden-controller-apis-v1alpha2-policyserver[$$PolicyServer$$]
- xref:{anchor_prefix}-github-com-kubewarden-kubewarden-controller-apis-v1alpha2-policyserverlist[$$PolicyServerList$$]



[id="{anchor_prefix}-github-com-kubewarden-kubewarden-controller-apis-v1alpha2-admissionpolicy"]
==== AdmissionPolicy 
...
| *`spec`* __xref:{anchor_prefix}-github-com-kubewarden-kubewarden-controller-apis-v1alpha2-admissionpolicyspec[$$AdmissionPolicySpec$$]__ | 
|===


[id="{anchor_prefix}-github-com-kubewarden-kubewarden-controller-apis-v1alpha2-admissionpolicylist"]
==== AdmissionPolicyList 
...
| *`items`* __xref:{anchor_prefix}-github-com-kubewarden-kubewarden-controller-apis-v1alpha2-admissionpolicy[$$AdmissionPolicy$$] array__ | 
|===


[id="{anchor_prefix}-github-com-kubewarden-kubewarden-controller-apis-v1alpha2-admissionpolicyspec"]
==== AdmissionPolicySpec 
...
|===
| Field | Description
| *`PolicySpec`* __xref:{anchor_prefix}-github-com-kubewarden-kubewarden-controller-apis-v1alpha2-policyspec[$$PolicySpec$$]__ | 
|===


[id="{anchor_prefix}-github-com-kubewarden-kubewarden-controller-apis-v1alpha2-clusteradmissionpolicy"]
...
| *`spec`* __xref:{anchor_prefix}-github-com-kubewarden-kubewarden-controller-apis-v1alpha2-clusteradmissionpolicyspec[$$ClusterAdmissionPolicySpec$$]__ | 
|===


[id="{anchor_prefix}-github-com-kubewarden-kubewarden-controller-apis-v1alpha2-clusteradmissionpolicylist"]
...
| *`items`* __xref:{anchor_prefix}-github-com-kubewarden-kubewarden-controller-apis-v1alpha2-clusteradmissionpolicy[$$ClusterAdmissionPolicy$$] array__ | 
|===


[id="{anchor_prefix}-github-com-kubewarden-kubewarden-controller-apis-v1alpha2-clusteradmissionpolicyspec"]
...
[id="{anchor_prefix}-github-com-kubewarden-kubewarden-controller-apis-v1alpha2-policymode"]
==== PolicyMode (string) 
...
.Appears In:
****
- xref:{anchor_prefix}-github-com-kubewarden-kubewarden-controller-apis-v1alpha2-policyspec[$$PolicySpec$$]
****



[id="{anchor_prefix}-github-com-kubewarden-kubewarden-controller-apis-v1alpha2-policymodestatus"]
...
.Appears In:
****
- xref:{anchor_prefix}-github-com-kubewarden-kubewarden-controller-apis-v1alpha2-policystatus[$$PolicyStatus$$]
****



[id="{anchor_prefix}-github-com-kubewarden-kubewarden-controller-apis-v1alpha2-policyserver"]
==== PolicyServer 
...
| *`spec`* __xref:{anchor_prefix}-github-com-kubewarden-kubewarden-controller-apis-v1alpha2-policyserverspec[$$PolicyServerSpec$$]__ | 
|===


[id="{anchor_prefix}-github-com-kubewarden-kubewarden-controller-apis-v1alpha2-policyserverlist"]
==== PolicyServerList 
...
| *`items`* __xref:{anchor_prefix}-github-com-kubewarden-kubewarden-controller-apis-v1alpha2-policyserver[$$PolicyServer$$] array__ | 
|===


[id="{anchor_prefix}-github-com-kubewarden-kubewarden-controller-apis-v1alpha2-policyserverspec"]
==== PolicyServerSpec 
...
[id="{anchor_prefix}-github-com-kubewarden-kubewarden-controller-apis-v1alpha2-policyspec"]
==== PolicySpec 
...
.Appears In:
****
- xref:{anchor_prefix}-github-com-kubewarden-kubewarden-controller-apis-v1alpha2-admissionpolicyspec[$$AdmissionPolicySpec$$]
- xref:{anchor_prefix}-github-com-kubewarden-kubewarden-controller-apis-v1alpha2-clusteradmissionpolicyspec[$$ClusterAdmissionPolicySpec$$]
****
...
[id="{anchor_prefix}-github-com-kubewarden-kubewarden-controller-apis-v1alpha2-policystatusenum"]
