...
var _ = Describe("ClusterAdmissionPolicyGroup controller", Label("real-cluster"), func() {
	...
	When("creating a wronggly defined PolicyGroup", Ordered, func() {
		// this test triggers kubebuilder/controller-gen markers tags for PolicyGroupmember{} and GroupSpec{}
