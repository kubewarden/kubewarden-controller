...
func findAdmissionPoliciesForConfigMap(object client.Object) []reconcile.Request {
...
func findClusterAdmissionPoliciesForConfigMap(object client.Object) []reconcile.Request {
	configMap, ok := object.(*corev1.ConfigMap)
	if !ok {
		return []reconcile.Request{}
	}
...
func findAdmissionPoliciesForPod(ctx context.Context, k8sClient client.Client, object client.Object) []reconcile.Request {
	...
	return findAdmissionPoliciesForConfigMap(&configMap)
}

func findClusterAdmissionPoliciesForPod(ctx context.Context, k8sClient client.Client, object client.Object) []reconcile.Request {
	pod, ok := object.(*corev1.Pod)
	if !ok {
		return []reconcile.Request{}
	}
	...
	return findClusterAdmissionPoliciesForConfigMap(&configMap)
}

func findClusterAdmissionPoliciesForPolicyServer(ctx context.Context, k8sClient client.Client, object client.Object, namespace string) []reconcile.Request {
...
func findClusterAdmissionPolicyForWebhookConfiguration(webhookConfiguration client.Object, log logr.Logger) []reconcile.Request {
...
func findAdmissionPoliciesForPolicyServer(ctx context.Context, k8sClient client.Client, object client.Object, namespace string) []reconcile.Request {
	policyServer, ok := object.(*policiesv1.PolicyServer)
	if !ok {
		return []reconcile.Request{}
	}
...
func findAdmissionPolicyForWebhookConfiguration(webhookConfiguration client.Object, log logr.Logger) []reconcile.Request {
	if _, found := webhookConfiguration.GetLabels()["kubewarden"]; !found {
		return []reconcile.Request{}
	}
