...
func (r *ClusterAdmissionPolicyGroup) GetContextAwareResources() []ContextAwareResource {
	// FIXME: This is a temporary to make compiler happy
	// Controller needs to be updated to handle this
	// A policy group members can have multiple context aware resources
	return r.Spec.Policies[0].ContextAwareResources
}
