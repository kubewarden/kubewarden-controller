...
{{/*
Helpers from kubewarden-defaults
*/}}

{{/*
Expand the name of the defaults chart.
*/}}
...
{{/*
Create chart name and version as used by the defaults chart label.
*/}}
...
{{/*
Common labels for defaults resources
*/}}
...
{{/*
Selector labels for defaults resources
*/}}
