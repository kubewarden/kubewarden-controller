...
func main() {
	...
	if err = setupReconcilers(mgr, deploymentsNamespace, webhookServiceName, enableMetrics, enableTracing, alwaysAcceptAdmissionReviewsOnDeploymentsNamespace, featureGateAdmissionWebhookMatchConditions, enableOtelSidecar, openTelemetryCertificateSecret, openTelemetryClientCertificateSecret); err != nil {
